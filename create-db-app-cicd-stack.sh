...
export TF_VAR_source_code_bucket_name=$(jq -r .source_code_bucket_name.value tf_output_source_code_bucket.json)
export TF_VAR_source_code_bucket_arn=$(jq -r .source_code_bucket_arn.value tf_output_source_code_bucket.json)

echo "==> Exported Terraform variables:"
echo "TF_VAR_source_code_bucket_name = $TF_VAR_source_code_bucket_name"
echo "TF_VAR_source_code_bucket_arn  = $TF_VAR_source_code_bucket_arn"
